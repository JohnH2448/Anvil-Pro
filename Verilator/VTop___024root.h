...
class alignas(VL_CACHE_LINE_BYTES) VTop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        VL_IN8(clock,0,0);
        VL_IN8(reset,0,0);
        CData/*4:0*/ Top__DOT__freeTag1;
        CData/*7:0*/ Top__DOT__upperSource1Status;
        CData/*7:0*/ Top__DOT__upperSource2Status;
        CData/*7:0*/ Top__DOT__lowerSource1Status;
        CData/*7:0*/ Top__DOT__lowerSource2Status;
        CData/*7:0*/ Top__DOT__oldLowerStatus;
        CData/*7:0*/ Top__DOT__oldUpperStatus;
        ...
        CData/*5:0*/ Top__DOT__reorderBuffer__DOT__headPointer;
        CData/*5:0*/ Top__DOT__reorderBuffer__DOT__tailPointer;
        CData/*5:0*/ Top__DOT__reorderBuffer__DOT__redirectPointer;
        CData/*5:0*/ Top__DOT__reorderBuffer__DOT__nextHeadPointer;
        CData/*5:0*/ Top__DOT__reorderBuffer__DOT__nextTailPointer;
        ...
        CData/*4:0*/ Top__DOT__reorderBuffer__DOT__minIndex1;
        CData/*4:0*/ Top__DOT__reorderBuffer__DOT__minIndex2;
        CData/*4:0*/ Top__DOT__reorderBuffer__DOT__minValue2;
        CData/*0:0*/ Top__DOT__reorderBuffer__DOT__found1;
        CData/*0:0*/ Top__DOT__reorderBuffer__DOT__found2;
        CData/*4:0*/ Top__DOT__reorderBuffer__DOT____VdfgTmp_h7cf4e22f__0;
        CData/*7:0*/ Top__DOT__operandSelect__DOT__upperSource1Status;
        CData/*7:0*/ Top__DOT__operandSelect__DOT__upperSource2Status;
        CData/*7:0*/ Top__DOT__operandSelect__DOT__lowerSource1Status;
        CData/*7:0*/ Top__DOT__operandSelect__DOT__lowerSource2Status;
    ...
    struct {
        ...
        CData/*0:0*/ Top__DOT__decodeIssue__DOT__reasonUpperLoadHazard;
        CData/*0:0*/ Top__DOT__decodeIssue__DOT__reasonLowerLoadHazard;
        ...
        SData/*12:0*/ Top__DOT__rstBus1;
        SData/*12:0*/ Top__DOT__rstBus2;
        SData/*12:0*/ Top__DOT__rstBus3;
        ...
        VlWide<4>/*113:0*/ Top__DOT__payload1;
        VlWide<4>/*108:0*/ Top__DOT__payload2;
        QData/*43:0*/ Top__DOT__instructionPacket1;
        QData/*43:0*/ Top__DOT__instructionPacket2;
        VlWide<5>/*153:0*/ Top__DOT__exPayload1;
        VlWide<5>/*150:0*/ Top__DOT__exPayload2;
        QData/*42:0*/ Top__DOT__resultPayload1;
        QData/*42:0*/ Top__DOT__resultPayload2;
        VlWide<3>/*78:0*/ Top__DOT__memPayload;
        QData/*42:0*/ Top__DOT__completedMemory;
        VlWide<3>/*70:0*/ Top__DOT__memBusOut;
    };
    struct {
        VlWide<3>/*68:0*/ Top__DOT__storeBus1;
        VlWide<3>/*68:0*/ Top__DOT__storeBuffer__DOT____Vlvbound_ha6fc8e3e__0;
        QData/*32:0*/ Top__DOT__placeholderDMEM__DOT__memBusInRegister;
        VlWide<5>/*153:0*/ Top__DOT__operandSelect__DOT__exPayloadCandidate1;
        VlWide<5>/*150:0*/ Top__DOT__operandSelect__DOT__exPayloadCandidate2;
        VlWide<4>/*113:0*/ Top__DOT__decodeIssue__DOT__tempPayload2;
        VlWide<4>/*113:0*/ Top__DOT__decodeIssue__DOT__tempPayload1;
        VlWide<4>/*113:0*/ Top__DOT__decodeIssue__DOT__finalUpperPayload;
        VlWide<4>/*108:0*/ Top__DOT__decodeIssue__DOT__finalLowerPayload;
        VlUnpacked<VlWide<3>/*82:0*/, 8> Top__DOT__memoryQueue__DOT__queueEntry;
        VlUnpacked<VlWide<3>/*68:0*/, 20> Top__DOT__storeBuffer__DOT__shiftEntries;
        VlUnpacked<IData/*31:0*/, 1024> Top__DOT__placeholderDMEM__DOT__memory;
        VlUnpacked<VlWide<3>/*75:0*/, 32> Top__DOT__reorderBuffer__DOT__reorderBuffer;
        VlUnpacked<CData/*4:0*/, 32> Top__DOT__reorderBuffer__DOT__sortGrid;
        VlUnpacked<VlUnpacked<CData/*0:0*/, 3>, 32> Top__DOT__reorderBuffer__DOT__maskGrid;
